...
import com.servegame.lmelo.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat5 = new Categoria(null,"Moda Feminina");
		Categoria cat6 = new Categoria(null,"Moda Masculina");
		Categoria cat7 = new Categoria(null,"Moda Infantil");
		Categoria cat8 = new Categoria(null,"Esportes");
		Categoria cat9 = new Categoria(null,"Brinquedos");
		Categoria cat10 = new Categoria(null,"Eletrodomésticos");
